...
doc.font("Open-Sans");
doc.text(
  "Remito a usted Expediente de Título, Carta de Solicitud al Sr. Rector del egresado de esta Facultad que solicita le conceda el Título que se indica a continuación:",
  margin
);
doc.moveDown(2);
