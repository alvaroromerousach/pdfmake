...
doc.moveDown(2);
doc.font("Open-Sans");
doc.text("Me permito solicitar a Ud., se conceda el título de xxxxxx a ", margin);
doc.moveDown(1);
doc.text("El (la) interesado(a), ha cumplido satisfacoriamente con las exigencias fijadas en el Plan de Estudio, Resolución(es) N° xxxx xxxx xxxxx", margin);
doc.moveDown(1);
doc.text("Los antecedentes han sido debidamente verificados por el suscrito, quien se responsabiliza de la corrección de la documentación que se acompaña.", margin);
doc.moveDown(1);
doc.text("De acuerdo a los antecedentes, completó sus requesitos para obtener el xxxxxxx con fecha de xx x  x x x x x x", margin);
doc.moveDown(3);
doc.font("Open-Sans");
